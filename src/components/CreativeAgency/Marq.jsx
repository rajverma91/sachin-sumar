            ...
            <div className="main-marq light-text">
              <div className="slide-har st1">
                <div className="box non-strok">
                  ...
                  <div className="item">
                    <h4 className="d-flex align-items-center"><span>Website Development</span> <span
                      className="fz-50 ml-50 stroke icon">*</span></h4>
                  </div>
                  <div className="item">
                ...
                <div className="item">
                  ...
                  <div className="item">
                    <h4 className="d-flex align-items-center"><span>Video Editing</span> <span
                      className="fz-50 ml-50 stroke icon">*</span></h4>
                  </div>
                  <div className="item">
                    <h4 className="d-flex align-items-center"><span>All Types Of Shoots</span> <span
                      className="fz-50 ml-50 stroke icon">*</span></h4>
                  </div>
