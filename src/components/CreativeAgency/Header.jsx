        ...
        <div className="row justify-content-center full-height">
          ...
          <div className="col-lg-6 valign">
            <div className="caption text-center full-width md-mb50">
              ...
              <h4 className="fw-300 mb-15">Aksh Digital Solutions</h4>
              <h3 className="fw-600 d-rotate wow">
                <span className="rotate-text">Driving Digital Growth with Strategy, Creativity & Precision </span>
                <span className="rotate-text">By Sachin Kumar</span>
              </h3>
            </div>
          </div>
